...
<body class="">
	...
	<main id="principal">
		...
		<div class=" container ">
			...
			<div id="servicos-card" class="col-md-8 mx-auto">




				<a
					class="col-md-2 col-sm-4 btn btn-custom my-4  btn-outline-light text-decoration-none"
					href="/ProjetoRua/controller?call=ListarHistoriasForm"> <i
					class="fas fa-arrow-left"></i> Voltar
				</a> <br> 
				<div class="row card text-white bg-dark">

					<h5 class="fw-bold pb-2 mt-3">Leia a história de
						${formatUtf8.getUtf8( beneficiario.getPrimeiroNome())}</h5>
					<div class="row pb-2 fw-normal">

						<div class=" col-md-12 text-custom-justify" style="text-align: justify;">${formatUtf8.getUtf8( beneficiario.getHistoria())}</div>
					...
					<div class="row pb-2">
						...
						<div class="col-md-6 fw-normal">
							<span class="fw-bold">Raça/Cor:</span> ${formatUtf8.getUtf8( beneficiario.getEtnia())}
						</div>
					...
					<div class="row pb-2">
						<div class="col-md-6 fw-normal">
							<span class="fw-bold">Idade:</span> ${beneficiario.getIdade() }



						</div>
						<div class="col-md-6 fw-normal">
							<span class="fw-bold">Tempo nas Ruas:</span> ${ beneficiario.getTempoNasRuas()}
							anos
						</div>
					...
					<div class="row ">
						<div class="col-md-6 fw-normal">
							<span class="fw-bold">Região:</span> ${ formatUtf8.getUtf8(usuarioLogado.getEndereco().getBairro())},
					...
					<div class="row ">
						<div class="col-12 fw-normal">
							<span class="fw-bold">Vulnerabilidades:</span> 
						...
						<c:forEach items="${dificuldades}" var="dificuldade">
							...
							<div  class="my-2 col-md-6 p-3">
								<label class="likert-slider form-label fw-bold">${ dificuldade.getNome()}:</label>
								<input id="historia" type="range" min="1" max="7"value="${dificuldade.getEscala()}" class="slider" disabled>
