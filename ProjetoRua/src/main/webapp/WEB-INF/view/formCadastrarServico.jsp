...
<!-- 					//////////////////////////// -->
					...
					<div class="form-check col-md-8">
						...
						<label class="form-check-label form-label">Dias em que o
							serviço está ativo: </label>

					</div>


				<div class="row mx-auto" style=" font-size: 16px;">
				
				<div class="col-md-2"></div>

						<div class="form-check col-md-1 col-sm-6 text-center ">

							<label class="form-check-label form-label" for="flexCheckSegunda">Segunda
							</label> <input class="form-check-input " type="checkbox" name="segunda"
								id="flexCheckSegunda">
						...
						<div class="form-check col-md-1 col-sm-6 text-center ">
							...
							<label class="form-check-label form-label" for="flexCheckTerca">Terça
							</label> <input class="form-check-input " type="checkbox" name="terca"
								id="flexCheckTerca">
						...
						<div class="form-check col-md-1 col-sm-6 text-center ">
							...
							<label class="form-check-label form-label" for="flexCheckQuarta">Quarta</label>
						...
						<div class="form-check col-md-1 col-sm-6 text-center ">
							...
							<label class="form-check-label form-label" for="flexCheckQuinta">Quinta
							</label> <input class="form-check-input " type="checkbox" name="quinta"
								id="flexCheckQuinta">
						...
						<div class="form-check col-md-1 col-sm-6 text-center ">
							...
							<label class="form-check-label form-label" for="flexCheckSexta">Sexta
							</label> <input class="form-check-input " type="checkbox" name="sexta"
								id="flexCheckSexta">
						...
						<div class="form-check col-md-1 col-sm-6 text-center ">
							...
							<label class="form-check-label form-label" for="flexCheckSabado">Sábado
							</label> <input class="form-check-input " type="checkbox" name="sabado"
								id="flexCheckSabado">
						...
						<div class="form-check col-md-1 col-sm-6 text-center">
							...
							<label class="form-check-label form-label" for="flexCheckDomingo">Domingo
							</label> <input class="form-check-input " type="checkbox" name="domingo"
								id="flexCheckDomingo">
						...
						<div class="col-md-5 col-sm-12">
							<label for="rua" class="form-label">Rua</label> <input
								type="text" class="form-control" id="rua" name="rua" required>
						</div>
						<div  class="col-md-2 d-none d-md-block"></div>
						<!-- quarta linha -->
