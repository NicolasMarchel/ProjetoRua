...
<%@ page
	import="br.com.tcc.projetorua.model.Endereco,br.com.tcc.projetorua.model.Categoria,br.com.tcc.projetorua.security.FormatUtf8, br.com.tcc.projetorua.model.Recorrencia, br.com.tcc.projetorua.model.Servico"%>

<%@ page import="br.com.tcc.projetorua.model.Dificuldade"%>
...
<body class="">
	...
	<main id="principal">
		...
		<ul id="list-unstyled">
			...
			<c:choose>
				<c:when test="${empty usuarioLogado.getHistoria()}">
					...
					<a class="btn my-4  btn-outline-light text-decoration-none"
						href="/ProjetoRua/controller?call=CadastrarHistoriaForm">+
						Cadastrar História</a>
				...
				<c:otherwise>
					...
					<div id="servicos-card" class=" container ">
						...
						<a class="btn my-4 btn-outline-light text-decoration-none fw-bold"
						href="/ProjetoRua/controller?call=CadastrarHistoriaForm">+
						Atualizar História</a>
						<br /><br />
							<div class="row card text-white bg-dark">

								<h5 class="fw-bold pb-2 mt-3">Seu Relato:</h5>
								<div class="row pb-2 fw-normal">

									<div class=" col-md-12 text-custom-justify" style="text-align: justify;">${formatUtf8.getUtf8( usuarioLogado.getHistoria())}</div>
								...
								<div class="row pb-2">
									<div class="col-md-6 fw-normal">
										<span class="fw-bold">Gênero:</span> ${formatUtf8.getUtf8( usuarioLogado.getGenero())}
									</div>
									<div class="col-md-6 fw-normal">
										<span class="fw-bold">Raça/Cor:</span> ${formatUtf8.getUtf8( usuarioLogado.getEtnia())}
									</div>
								...
								<div class="row pb-2">
									...
									<fmt:formatDate value="${usuarioLogado.getDateNascimento()}" pattern="dd/MM/yyyy"/> 
									
									</div>
									<div class="col-md-6 fw-normal">
										<span class="fw-bold">Tempo nas Ruas:</span>
										${formatUtf8.getUtf8( usuarioLogado.getTempoNasRuas())} anos
									</div>
								...
								<div class="row pb-2">
									<div class="col-md-8 fw-normal">
										<span class="fw-bold">Região:</span>
										${ formatUtf8.getUtf8(usuarioLogado.getEndereco().getBairro())}, 
										${ formatUtf8.getUtf8(usuarioLogado.getEndereco().getCidade())} -  
										${ formatUtf8.getUtf8(usuarioLogado.getEndereco().getEstado())} 
								...
								<div class="row pb-2">
									...
									<c:forEach items="${dificuldades}" var="dificuldade">




										<div id="" class="my-2 col-md-6">
											<label class="likert-slider form-label fw-bold">${ dificuldade.getNome()}:</label>
											<input id="historia"  type="range" min="1" max="7"
												value="${dificuldade.getEscala()}" class="slider" disabled >
