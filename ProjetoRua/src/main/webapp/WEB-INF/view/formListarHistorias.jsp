...
<%@ page
	import="br.com.tcc.projetorua.model.Categoria,br.com.tcc.projetorua.model.Dificuldade,br.com.tcc.projetorua.security.FormatUtf8, br.com.tcc.projetorua.model.Recorrencia, br.com.tcc.projetorua.model.Servico"%>
...
<body class="">
	...
	<main id="principal">
		...
		<section id="" class="">
			...
			<c:choose>
				<c:when test="${empty beneficiarios}">
					...
					<div class="container text-center">
						<div class="mx-auto">
							<br /> <br /> <br /> <br /> <br />
							<div>Nenhuma história cadastrada!</div>
				...
				<c:otherwise>
					...
					<div class="album py-4 ">
						<div class="container">
							...
							<!-- 											<option value="2">Preconceito</option> -->
							<!-- 											<option value="3">Saúde</option> -->
							<!-- 											<option value="4">Violência física</option> -->
							<!-- 											<option value="5">Abrigo</option> -->
							<!-- 											<option value="6">Trabalho</option> -->
							<!-- 											<option value="7">Higiene</option> -->
							<!-- 											<option value="8">Hidratação</option> -->
							<!-- 										</select> -->
								...
								<div class="col-md-10 col-sm-12 mx-auto">
									...
									<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
										...
										<c:forEach items="${beneficiarios}" var="beneficiario">
											...
											<c:if test="${not empty beneficiario.getHistoria()}">

<div class="col">
												<div id="card-historias" class="p-2 card shadow-sm p-1"
													...
													<div id="cardListarHistorias"
														class="my-3 card-img-top rounded-circle mx-auto d-flex align-items-center overflow-hidden justify-content-center"
														style="width: 192px; height: 144px; border: 5px solid #343a40;">
														<img
															src="data:image/${beneficiario.getAvatar().getExtensao()};base64,${beneficiario.getAvatar().getFoto()}"
															class="img-fluid my-3 card-img-top rounded-circle mx-auto d-flex align-items-center overflow-hidden justify-content-center">
													</div>
													...
													<!-- 												<p class="card-text fw-normal mb-1 pb-0"> -->
													<%-- 													<span class="fw-bold">Gênero:</span> ${formatUtf8.getUtf8( beneficiario.getGenero())} --%>
													<!-- 												</p> -->
													<!-- 												<p class="card-text fw-normal mb-1 pb-0"> -->
													<!-- 													<span class="fw-bold">Raça/Cor:</span> -->
													<%-- 													${formatUtf8.getUtf8( beneficiario.getEtnia())} --%>
													<!-- 												</p> -->
													<!-- 												<p class="card-text fw-normal mb-1 pb-0"> -->
													<!-- 													<span class="fw-bold">Idade: </span> -->
													<%-- 													${beneficiario.getIdade()} anos --%>
													<!-- 												</p> -->
													<!-- 												<p class="card-text fw-normal mb-1 pb-1"> -->
													<!-- 													<span class="fw-bold">Tempo nas Ruas:</span> -->
													<%-- 													${formatUtf8.getUtf8( beneficiario.getTempoNasRuas())} anos --%>
													<!-- 												</p> -->
													...
													<div
														class="card-text justify-content-between align-items-center"
														style="text-align: justify;">
														<p class=" m-2">${fn:substring(beneficiario.getHistoria(), 0, 85)}
															${fn:length(beneficiario.getHistoria()) > 85 ? '...' : ''}</p>
													</div>
													...
													<div
														...
														<a class="btn btn-sm btn-outline-secondary "
															href="/ProjetoRua/controller?call=VisualizarHistoriaForm&id=${beneficiario.getId()}">View</a>
														<small class="text-body-secondary text-center"> <!-- 														<span	class="fw-bold col-12 d-none d-md-block">Cadastrado	em: </span> -->
															<fmt:formatDate
																value="${beneficiario.getDatePublicacao() }"
																pattern="dd/MM/yyyy" />
														</small>
													</div>
												</div>
